...
public class ByPriceFragment extends Fragment implements View.OnClickListener{
    private View view;
    private Button mShowMoreFilters,mSearch;
    private ArrayList<BrandModel> brandModelArrayList = new ArrayList<>();
    private LinearLayout mBrandRecyclerViewLayout;

    public static ByPriceFragment newInstance(Bundle b) {
        ByPriceFragment fragment = new ByPriceFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frag_price, container, false);

        mShowMoreFilters = (Button)view.findViewById(R.id.btn_show_more_filters);
        mShowMoreFilters.setOnClickListener(this);

        mSearch = (Button)view.findViewById(R.id.btn_search);
        mSearch.setOnClickListener(this);

        mBrandRecyclerViewLayout = (LinearLayout) view.findViewById(R.id.lay_recycler);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.btn_show_more_filters:

                mShowMoreFilters.setVisibility(View.INVISIBLE);
                mBrandRecyclerViewLayout.setVisibility(View.VISIBLE);
                setRecyclerView();
                break;
